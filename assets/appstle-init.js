(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/0661/0989/9010/t/17/assets/appstle-subscription.js?v=1680631966");
      ...
      RS.Config = {
        ...
        "atcButtonSelector": ".product-form__btn-group",
        "moneyFormat": "{% raw %}${{amount}}{% endraw %}",
        "oneTimePurchaseText": "One Time Purchase",
        "shop": "amaroseofficial.myshopify.com",
